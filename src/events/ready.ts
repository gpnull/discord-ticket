...
export default class ReadyEvent extends BaseEvent {
	...
	public async execute()  {
		...
		const embed = new EmbedBuilder({
			...
			.setImage('https://cdn.discordapp.com/attachments/1190206336647036938/1192902084966744124/Banner_Discord_sentticket.png?ex=65aac3a4&is=65984ea4&hm=c1956707394be98cf0871aa79f5058f1a2f18d84b9a25fbbe09d4a94e838fbe4&')
